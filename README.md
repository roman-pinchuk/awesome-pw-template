...
| **@playwright/test**              | devDependencies | `1.62.1`        | No known issues | `1.63.0`           |
...
| **lint-staged**                   | devDependencies | `^17.4.1`       | No known issues | `17.5.0`           |
...
| **typescript-eslint**             | devDependencies | `8.68.0`        | No known issues | `8.69.0`           |
